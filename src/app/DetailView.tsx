      ...
      <div className="row g-5">
        <main className="col-12 col-lg-8 order-2 order-lg-1">
          ...
          <div className="markdown-body">
            ...
            <div className="rounded-4 overflow-hidden border border-secondary shadow-lg" style={{ height: '70vh', backgroundColor: '#fff' }}>
              <iframe 
            ...
            <div className="markdown-body">
              <p>Este proyecto no tiene un README configurado para mostrar, o el contenido aún se está cargando.</p>
            </div>
          )}
          </div>
        </main>
